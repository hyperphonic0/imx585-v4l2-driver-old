...
#define IMX585_NATIVE_WIDTH		3860U   //3860 -> banding issue
...
static int imx585_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_EXPOSURE:
		...
		dev_info(&client->dev,"\tVMAX:%d, HMAX:%d\n",imx585->VMAX, imx585->HMAX);
		u64 shr = calculate_shr(ctrl->val, imx585->HMAX, imx585->VMAX, 0, 0);
	...
	case V4L2_CID_HBLANK:
		...
		u64 hmax = (u64)(mode->width + ctrl->val) * 74250000;
